...
const HabitCard = () => {
  ...
  return (
    <div className="border-2 border-black rounded-xl p-4 m-5 w-64 bg-white">
      <h2 className={`text-lg font-semibold mb-2 ${done ? "line-through text-gray-400" : ""}`}>Habit Name</h2>
      <p className={`text-sm mb-4 ${done ? "text-gray-400" : "text-gray-600"}`}>Description of the habit</p>
